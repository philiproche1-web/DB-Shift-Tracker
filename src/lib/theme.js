...
export const DARK  = {BG:"#07090F",CARD:"#0D1321",BORDER:"#1A2438",CARD2:"#141B2D",TEXT:"#FFFFFF",MUTED:"#8C99B8",INPUT:"#0A0E1A"};
export const LIGHT = {BG:"#F5F7FA",CARD:"#FFFFFF",BORDER:"#D8DFE8",CARD2:"#EEF1F5",TEXT:"#0D1321",MUTED:"#64748B",INPUT:"#FFFFFF"};
