...
export function WhatsNewIcon({type}) {
  ...
  if(type==="account") return <div style={wrap}><svg viewBox="0 0 24 24" style={s}><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4.4 3.6-7 8-7s8 2.6 8 7"/></svg></div>;
  if(type==="garage") return <div style={wrap}><svg viewBox="0 0 24 24" style={s}><path d="M3 21V9l9-6 9 6v12"/><path d="M3 21h18"/><rect x="9" y="13" width="6" height="8"/></svg></div>;
  ...
  if(type==="duty") return <div style={wrap}><svg viewBox="0 0 24 24" style={s}><rect x="3" y="4" width="18" height="16" rx="2"/><line x1="8" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="16" y2="14"/></svg></div>;
  if(type==="help") return <div style={wrap}><svg viewBox="0 0 24 24" style={s}><circle cx="12" cy="12" r="9"/><path d="M9.5 9a2.5 2.5 0 0 1 5 0c0 2-2.5 2-2.5 4"/><line x1="12" y1="17" x2="12" y2="17.01"/></svg></div>;
  return null;
}
