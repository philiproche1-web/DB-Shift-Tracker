  ...
  return (
    <div style={{background:BG,height:"100vh",display:"flex",flexDirection:"column",overflow:"hidden"}}>
      <div style={{padding:"32px 20px 16px",background:`linear-gradient(180deg,${CARD2} 0%,${BG} 100%)`}}>
        <p style={{color:ACCENT,fontSize:"0.6875rem",textTransform:"uppercase",letterSpacing:2,fontWeight:700,margin:"0 0 6px"}}>{readOnly?"Reference":"Before you begin"}</p>
        <h1 style={{color:TEXT,fontSize:"1.5rem",fontWeight:800,margin:"0 0 4px",letterSpacing:"-0.5px"}}>Terms & Conditions</h1>
        <p style={{color:MUTED,fontSize:"0.8125rem",margin:0}}>{readOnly?"For your reference":"Please read carefully before using Dublin Bus Shift Tracker"}</p>
      </div>

      <div onScroll={checkScrollEnd} style={{flex:1,overflowY:"auto",padding:"0 16px 16px"}}>
        <div style={{background:CARD,border:`1px solid ${BORDER}`,borderRadius:16,padding:"18px 16px",marginBottom:16,fontSize:"0.875rem",lineHeight:1.7,color:TEXT}}>

          <p style={{color:TEXT,fontWeight:700,fontSize:"0.9375rem",margin:"0 0 8px"}}>1. Ownership &amp; Intellectual Property</p>
          ...
          <p style={{color:TEXT,fontWeight:700,fontSize:"0.9375rem",margin:"0 0 8px"}}>2. Private Use Only</p>
          ...
          <p style={{color:TEXT,fontWeight:700,fontSize:"0.9375rem",margin:"0 0 8px"}}>3. Data Accuracy &amp; Responsibility</p>
          ...
          <p style={{color:TEXT,fontWeight:700,fontSize:"0.9375rem",margin:"0 0 8px"}}>4. Running Board Data</p>
          ...
          <p style={{color:TEXT,fontWeight:700,fontSize:"0.9375rem",margin:"0 0 8px"}}>5. Data Storage &amp; Privacy</p>
          ...
          <p style={{color:TEXT,fontWeight:700,fontSize:"0.9375rem",margin:"0 0 8px"}}>6. Limitation of Liability</p>
          ...
          <p style={{color:TEXT,fontWeight:700,fontSize:"0.9375rem",margin:"0 0 8px"}}>7. Availability &amp; Access</p>
          ...
          <p style={{color:TEXT,fontWeight:700,fontSize:"0.9375rem",margin:"0 0 8px"}}>8. Safe Use</p>
        ...
        {!hasScrolledEnd && (
          <p style={{color:ACCENT,fontSize:"0.75rem",textAlign:"center",margin:"0 0 10px",fontWeight:600}}>Scroll to the bottom to continue ↓</p>
        )}
        ...
        <div onClick={()=>hasScrolledEnd&&setTick1(!tick1)} style={{background:CARD,border:`1px solid ${tick1?ACCENT:BORDER}`,borderRadius:14,padding:"16px",marginBottom:10,cursor:hasScrolledEnd?"pointer":"not-allowed",opacity:hasScrolledEnd?1:0.5,display:"flex",gap:14,alignItems:"flex-start"}}>
          ...
          <p style={{color:tick1?TEXT:MUTED,fontSize:"0.8125rem",fontWeight:tick1?600:400,margin:0,lineHeight:1.5}}>I have read and agree to the Terms &amp; Conditions above</p>
        </div>
        ...
        <div onClick={()=>hasScrolledEnd&&setTick2(!tick2)} style={{background:CARD,border:`1px solid ${tick2?ACCENT:BORDER}`,borderRadius:14,padding:"16px",marginBottom:20,cursor:hasScrolledEnd?"pointer":"not-allowed",opacity:hasScrolledEnd?1:0.5,display:"flex",gap:14,alignItems:"flex-start"}}>
          ...
          <p style={{color:tick2?TEXT:MUTED,fontSize:"0.8125rem",fontWeight:tick2?600:400,margin:0,lineHeight:1.5}}>I confirm I will not use this app while driving or operating a vehicle</p>
        </div>
